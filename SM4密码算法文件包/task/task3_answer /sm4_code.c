...
void sm4(unsigned char key[16],
    ...
    switch (mode) {
        case 0:
            sm4_crypt_ecb(&ctx, flag, length, input, output);break;
        case 1:
            sm4_crypt_cbc(&ctx, flag, length, iv, input, output);break;
        case 2:
            sm4_crypt_cfb(&ctx, flag, length, iv, input, output);break;
        case 3:
            sm4_crypt_ofb(&ctx, flag, length, iv, input, output);break;
        case 4:
            sm4_crypt_ctr(&ctx, flag, length, iv, input, output);break;
        default:
